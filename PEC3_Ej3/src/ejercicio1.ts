...
let everyisgreater = array.every(num => num > 3); //check if every number is greater than 3
console.log(everyisgreater);  //false
let everyisless = array.every(num => num < 10); // check if every number is less than 10
